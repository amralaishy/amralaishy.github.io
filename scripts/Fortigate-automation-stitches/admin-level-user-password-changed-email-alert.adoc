...
NOTE: This stitch works for 7.0.x & 7.2.x FortiOS versions, for 7.4.x and later see [admin-level-user-password-changed-email-alert-7.4.adoc](admin-level-user-password-changed-email-alert-7.4.adoc).
